    ...
    <div class="container mx-auto px-2 max-sm:pt-5">
        <div class="flex flex-col lg:flex-row">
            <div class="left-area xl:w-[70%] lg:h-[480px] flex flex-col justify-center">
                <h1 class="text-black text-center lg:text-left text-balance lg:text-wrap text-2xl md:text-4xl/12 xl:text-5xl/15 mb-5 font-semibold">
                    <?php echo esc_html(get_carbon_field('mit_hero_title')); ?>
                </h1>
                <h2 class="text-black text-center lg:text-left text-balance lg:text-wrap text-md md:text-lg xl:text-xl xl:w-[700px]">
                    <?php echo esc_html(get_carbon_field('mit_hero_content')); ?>
                </h2>
                <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 mt-10 lg:mb-20">
                    <a class="btn bg-transparent hover:bg-white text-black lg:text-lg xl:text-xl font-medium rounded-full px-15 sm:px-6 py-5  xl:px-9 xl:py-7 border-2 border-black"
                        href="<?php echo esc_url(get_carbon_field('mit_hero_cta_btn_link_1')); ?>">
                        <?php echo esc_html(get_carbon_field('mit_hero_cta_btn_text_1')); ?>
                    </a>
                    <a class="btn bg-theme-blue hover:bg-theme-blue-hover text-white lg:text-lg xl:text-xl font-medium rounded-full px-15 sm:px-6 py-5  xl:px-9 xl:py-7 border-2 border-transparent"
                        href="<?php echo esc_url(get_carbon_field('mit_hero_cta_btn_link_2')); ?>">
                        <?php echo esc_html(get_carbon_field('mit_hero_cta_btn_text_2')); ?>
                    </a>
                </div>
            </div>
...
<section class="meet-our-full-team-section py-[78px]">
    <div class="container mx-auto px-10 lg:px-2">
        ...
        if (get_carbon_field('mit_moft_cards')):
            ...
            <div class="show-all-btn-container text-center mt-16 mb-4">
                <a class="btn bg-theme-blue hover:bg-theme-blue-hover text-white lg:text-lg xl:text-xl font-medium rounded-full px-15 sm:px-6 py-5  xl:px-9 xl:py-7 border-2 border-transparent"
                    href="<?php echo esc_url(get_carbon_field('mit_moft_cta_btn_link')); ?>">
                    <?php echo esc_html(get_carbon_field('mit_moft_cta_btn_text')); ?>
                </a>
            </div>
                ...
                ?>
                    <div class="card-item mb-10">
                        <?php if (get_the_post_thumbnail()): ?>
                            <div class="image-container rounded-[20px] overflow-hidden relative group">
        ...
        <?php if ($is_video): ?>
            ...
            <span class="absolute inset-0 flex items-center justify-center">
                <svg width="90" height="90" viewBox="0 0 24 24"
                     fill="white" stroke="#24417C" stroke-width="2"
    ...
    <div class="container mx-auto px-5 lg:px-2 max-sm:pt-5">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="right-area">
                <h1 class="text-black text-balance text-center md:text-left text-2xl md:text-4xl xl:text-5xl mb-7">
...
<section class="feedback-section py-[78px]">
    <div class="container mx-auto px-5 lg:px-2">

        <h1 class="text-black text-center text-2xl md:text-4xl xl:text-5xl font-semibold mb-[64px]">
            <?php echo esc_html(get_carbon_field('mit_feedback_title')); ?>
        </h1>

        <?php if (get_carbon_field('mit_feedback_cards')): ?>
            <?php $cards = get_carbon_field('mit_feedback_cards'); ?>

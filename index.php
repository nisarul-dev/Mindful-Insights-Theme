                    ...
                    <div id="slide<?php echo esc_attr($i); ?>" class="carousel-item relative w-full">
                        <div class="flex flex-col justify-between lg:flex-row">
                            <div class="left-area w-[48%]">
                                <h3 class="text-font-gray text-4xl font-medium mb-[54px] mt-[52px]">
                                    <?php echo esc_html($slide['heading']); ?></h3>
                                ...
                                <div class="number text-black font-syne text-4xl  mt-[70px]">
                                    <?php echo esc_html(sprintf("%02d", $i)); ?>/<?php echo esc_html(sprintf("%02d", $count_slides)); ?>
                                </div>
                            </div>
                            <div class="right-area w-[50%] text-right pr-[20px]">
                                <?php
                                echo wp_get_attachment_image($slide['image'], 'full', false, array(
                                    'class' => 'h-[580px] object-cover ml-auto rounded-[20px]'
                                ));
                                ?>
                            </div>
                        </div>
